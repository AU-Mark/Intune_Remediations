# URL to the DelProf2 executable to be downloaded to the workstation
$DelProf2URL = "https://raw.githubusercontent.com/AU-Mark/Intune_Remediations/main/Stale%20User%20Profiles/DelProf2_1.6.0.exe"
...
If ($Profiles.Count -gt 0) {
    Try {
        ...
        # Download DelProf2
        Invoke-WebRequest -URI $DelProf2URL -OutFile "$env:TEMP\delprof2.exe"
